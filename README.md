...
| 🔐 **حماية بيانات وتوثيق متقدم (Direct Email OTP & Cloud Sync)** | توثيق حصري برموز OTP السحابية (6-8 خانات)، واستعادة الحساب بدون روابط معقدة، ومزامنة سحابية 100% لجميع التفضيلات والجداول. |
...
graph TD
    ...
    B -->|Python Bridge| H[workout_generator_python Engine]
```
